...
This resume is based on the xelatex-templates from [deedydas](https://github.com/deedydas/Deedy-Resume/) and compiled into the repective `src` folder via a grunt task. 
